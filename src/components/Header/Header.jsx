...
const navigation = [
  ...
  { name: 'პარტნიორები', href: '/partners', current: false },
  { name: 'ჩვენს შესახებ', href: '/about_us', current: false },
  { name: 'კონტაქტი', href: '/contact_us', current: false },
]
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    ...
                    :
                    <button onClick={handleLogin} className='p-2 rounded-lg text-white text-sm font-semibold bg-indigo-600 hover:bg-indigo-800 duration-300 transition-all'>შესვლა</button>
                    }
                  </div>
                  <Transition
                    as={Fragment}
